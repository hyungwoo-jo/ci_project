...
run_one_simulation <- function(sim_id, n, true_ate) {
  ...
  #   # Clip propensity scores to avoid division by zero or extreme values
  #   epsilon <- 0.001
...
#   labs(title = "Distribution of ATE Estimates across 100 Simulations",
#        x = "Methodology",
...
# 
# ggsave("simulation_results_boxplot.png", plot = p, width = 12, height = 8, dpi = 300)
# 
# cat("\nBoxplot graph saved to simulation_results_boxplot.png\n")
